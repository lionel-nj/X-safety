...
for distribution in world.userInputs[1].distributions:
        ...
        for variation in variationRates:
            ...
            PETs = []
            interactions = []
            meanTimePercentageInCongestedState[distribution][variation] = []
            stdTimePercentageInCongestedState[distribution][variation] = []
            ...
            for seed in seeds:
                ...
                meanTimePercentageInCongestedState[distribution][variation].append(np.mean([u.getTimePercentageCongestion() for u in world.completed]))
                stdTimePercentageInCongestedState[distribution][variation].append(np.std([u.getTimePercentageCongestion() for u in world.completed]))
