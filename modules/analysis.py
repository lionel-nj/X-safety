...
from modules import makesimulation, network, simulation, toolkit
...
def run(worldFile, simulationParameters, analysisParameters):
    ...
    """script to get min of distances between each pair of vehicles in a car following situation """
    # il faut que les vehicules coexistent durant un certain minimum de pas de temps, sinon cela signifie que les données récoltées considèrent des véhicules qui sont à peine entrés
    # dans le système, n'ont pas eu le temps de se stabiliser.
    """script to get min of distances between each pair of veehicles crossing in an intersection  """

    """script to get speed when the distance between vehicles is at its lower value"""

    """script to get TTC between each pair of vehicles in a car following situation"""

    """script to get TTC between each pair of vehicles crossing in an intersection """"
