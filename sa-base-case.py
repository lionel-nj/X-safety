...
for seed in seeds:
    ...
    rearEndnInter10.append((np.array(minDistances[1]) <= 10).sum())
    rearEndnInter20.append((np.array(minDistances[1]) <= 20).sum())
    rearEndnInter50.append((np.array(minDistances[1]) <= 50).sum())

    sidenInter10.append((np.array(minDistances[2]) <= 10).sum())
    sidenInter20.append((np.array(minDistances[2]) <= 20).sum())
    sidenInter50.append((np.array(minDistances[2]) <= 50).sum())
