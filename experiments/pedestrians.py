...
pedestrians_world = network.World.load('config files/pedestrians-yield.yml')
pedestrians_sim = simulation.Simulation.load('config files/pedestrians-yield-config.yml')
